public class Config {
	...
	public static ScoreList EXAMPLE_SCORELIST;
	
	
	public static ScoreList getExample(){
		EXAMPLE_SCORELIST.add(new Score("h1",34,50));
		EXAMPLE_SCORELIST.add(new Score("h2",29,30));
		EXAMPLE_SCORELIST.add(new Score("p1",195,200));
		EXAMPLE_SCORELIST.add(new Score("p2",230,240));
		EXAMPLE_SCORELIST.add(new Score("p3",50,80));
		EXAMPLE_SCORELIST.add(new Score("m1",57,66));
		EXAMPLE_SCORELIST.add(new Score("m2",61,66));
		EXAMPLE_SCORELIST.add(new Score("f",78,81));
		
		return EXAMPLE_SCORELIST;
	}
